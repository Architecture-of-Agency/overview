...
export default function PlaceBasedIdentity() {
  ...
  const content = {
    en: {
      ...
      overview: 'Overview',
      overviewText: 'This research initiative investigates whether place and location can serve as identity mechanisms for engaging with governance processes—offering an alternative to surveillance-based digital ID systems. Instead of tracking individuals, we explore how people can participate in decision-making through their connection to specific places, enabling meaningful civic engagement while protecting privacy and avoiding state surveillance.',
      
      problem: 'The digital identity problem',
      problemText: 'Traditional digital identity systems create comprehensive surveillance infrastructure—tracking individuals across contexts, building profiles, enabling state and corporate monitoring. Yet meaningful participation in governance often requires some form of verification. Can we create identity mechanisms that enable participation without surveillance? Can connection to place become a basis for civic engagement that protects rather than exposes people?',
      ...
      ex1: 'Neighborhood planning participation without personal identification',
      ...
      ex5: 'Democratic participation that doesn\'t feed surveillance infrastructure',
    ...
    cy: {
      ...
      overview: 'Trosolwg',
      overviewText: 'Mae\'r fenter ymchwil hon yn ymchwilio a all lle a lleoliad wasanaethu fel mecanweithiau hunaniaeth ar gyfer ymgysylltu â phrosesau llywodraethiant—gan gynnig dewis arall i systemau ID digidol seiliedig ar wyliadwriaeth. Yn hytrach na olrhain unigolion, rydym yn archwilio sut gall pobl gymryd rhan mewn gwneud penderfyniadau trwy eu cysylltiad â lleoedd penodol, gan alluogi ymgysylltiad dinesig ystyrlon tra\'n diogelu preifatrwydd ac osgoi gwyliadwriaeth y wladwriaeth.',
      
      problem: 'Problem hunaniaeth ddigidol',
      problemText: 'Mae systemau hunaniaeth ddigidol traddodiadol yn creu seilwaith gwyliadwriaeth cynhwysfawr—olrhain unigolion ar draws cyd-destunau, adeiladu proffiliau, galluogi monitro gan y wladwriaeth a chorfforaethau. Eto mae cyfranogiad ystyrlon mewn llywodraethiant yn aml yn gofyn am ryw fath o ddilysu. A allwn greu mecanweithiau hunaniaeth sy\'n galluogi cyfranogiad heb wyliadwriaeth? A all cysylltiad â lle ddod yn sail ar gyfer ymgysylltiad dinesig sy\'n diogelu yn hytrach nag yn amlygu pobl?',
      ...
      ex5: 'Cyfranogiad democrataidd nad yw\'n bwydo seilwaith gwyliadwriaeth',
